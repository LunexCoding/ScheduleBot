...
from helpers.calandarExceptions import (
...
class _ScheduleParser:
    ...
    def __getPageResponseWithAllGroups(self):
        return requests.get("https://xn--80aapkb3algkc.xn--j1afpl.xn--p1ai/%D0%B3%D1%80%D1%83%D0%BF%D0%BF%D1%8B.html")
